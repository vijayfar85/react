import './Header.scss';
import poland from '../images/bcloud-logo.svg';
	    ...
	    <div className="container">
	      <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
	        <Link to="/" className="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
	          <img src={poland} style={{width:'135px'}} alt=""/>
	        </Link>

	        <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
	          <li><Link to='/overview' className="nav-link px-2 link-dark">Overview</Link></li>
	          <li><Link to="/rewire" className="nav-link px-2 link-dark">Inventory</Link></li>
	          <li><Link to="/home" className="nav-link px-2 link-dark">Customers</Link></li>
